...
class CorosActivity(Base):
    ...
    ascent = Column(Integer, comment="h爬升（米）")
    descent = Column(Integer, comment="下降（米）")
    total_time = Column(Integer, comment="总耗时 (秒)")
    workout_time = Column(Integer, comment="净运动耗时 (秒)")
